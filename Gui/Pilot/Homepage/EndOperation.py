...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "End Operation"))
        self.btn_cancel.setText(_translate("Dialog", "Cancel"))
        self.btn_end.setText(_translate("Dialog", "End"))
        self.label.setText(_translate("Dialog", "<html><head/><body><p><span style=\" color:#2c365d;\">End Operation</span></p></body></html>"))
        self.label_2.setText(_translate("Dialog", "<html><head/><body><p><span style=\" font-size:13pt; color:#2c365d;\">Are you sure you want to end this operation?</span></p></body></html>"))
        self.label_3.setText(_translate("Dialog", "<html><head/><body><p><span style=\" font-size:13pt; color:#2c365d;\">This process cannot be undone</span></p></body></html>"))

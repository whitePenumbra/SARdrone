...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(985, 894)
        MainWindow.setMinimumSize(QtCore.QSize(985, 894))
        MainWindow.setMaximumSize(QtCore.QSize(985, 894))
        icon = QtGui.QIcon()
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(600, 20, 361, 33))
...
"                ")
        ...
        self.droneStream.setGeometry(QtCore.QRect(63, 70, 856, 480))
        self.droneStream.setMinimumSize(QtCore.QSize(856, 480))
        self.droneStream.setMaximumSize(QtCore.QSize(856, 480))
        self.droneStream.setObjectName("droneStream")
        self.droneMap = QtWidgets.QWidget(self.centralwidget)
        self.droneMap.setGeometry(QtCore.QRect(30, 570, 361, 311))
        self.droneMap.setMinimumSize(QtCore.QSize(361, 311))
        self.droneMap.setMaximumSize(QtCore.QSize(361, 16777215))
        self.droneMap.setObjectName("droneMap")
        self.layoutWidget1 = QtWidgets.QWidget(self.centralwidget)
        self.layoutWidget1.setGeometry(QtCore.QRect(410, 610, 162, 184))
...
"")
        ...
        self.droneConsole.setGeometry(QtCore.QRect(590, 570, 361, 151))
        self.droneConsole.setMinimumSize(QtCore.QSize(361, 151))
        self.droneConsole.setMaximumSize(QtCore.QSize(361, 151))
        self.droneConsole.setObjectName("droneConsole")
        self.droneConsole_2 = QtWidgets.QTextBrowser(self.centralwidget)
        self.droneConsole_2.setGeometry(QtCore.QRect(590, 730, 361, 151))
        self.droneConsole_2.setMinimumSize(QtCore.QSize(361, 151))
        self.droneConsole_2.setMaximumSize(QtCore.QSize(361, 151))

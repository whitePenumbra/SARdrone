...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.app_logo.setPixmap(QtGui.QPixmap("../Gui/Resources/aids_logo.png"))
...
"")
        ...
        self.aids_logo.setMinimumSize(QtCore.QSize(291, 45))
        self.aids_logo.setMaximumSize(QtCore.QSize(291, 45))
        font = QtGui.QFont()
        ...
        self.user_icon.setPixmap(QtGui.QPixmap("../Gui/Resources/user_icon.png"))
        ...
        self.password_icon.setPixmap(QtGui.QPixmap("../Gui/Resources/padlock_icon.png"))

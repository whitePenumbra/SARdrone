...
"")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Add Pilot Success"))
        self.btn_OK.setText(_translate("Dialog", "OK"))
        self.lbl_success.setText(_translate("Dialog", "<html><head/><body><p><span style=\" color:#2c365d;\">Pilot has been added successfully</span></p></body></html>"))

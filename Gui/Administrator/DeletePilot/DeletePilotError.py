...
"")
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(50, 20, 431, 123))
        ...
        self.lbl_error.setMinimumSize(QtCore.QSize(281, 49))
        self.lbl_error.setMaximumSize(QtCore.QSize(281, 49))
        font = QtGui.QFont()
        font.setFamily("Helvetica")
